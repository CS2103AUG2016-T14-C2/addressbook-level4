...
public class XmlSavvyTaskerStorageTest {
    private static String TEST_DATA_FOLDER = FileUtil.getPath("./src/test/data/XmlSavvyTaskerStorageTest/");
    ...
    public void read_notXmlFormat_exceptionThrown() throws Exception {
        ...
        readSavvyTasker("NotXmlFormatSavvyTasker.xml");
    ...
    @Test
    public void readAndSaveSavvyTasker_allInOrder_success() throws Exception {
        String filePath = testFolder.getRoot().getPath() + "TempSavvyTasker.xml";
